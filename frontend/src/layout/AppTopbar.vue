...
// Lógica de layout nativa do Sakai (para menu e tema)
const { toggleMenu, toggleDarkMode, isDarkTheme } = useLayout();

// Nossa lógica de gerenciamento de usuário com Pinia
const userStore = useUserStore();

// Lista de usuários para nosso seletor de simulação
// IMPORTANTE: Verifique se os IDs correspondem aos do seu banco de dados!
const testUsers = ref([
    { id: 2, username: 'vereador_teste', perfil: 'VEREADOR' },
    { id: 3, username: 'protocolo', perfil: 'PROTOCOLO' },
    { id: 4, username: 'zeladoria', perfil: 'SECRETARIA', secretariaId: 4 },
    { id: 5, username: 'gestor', perfil: 'GESTOR' }
]);

// Função que é chamada quando o usuário é trocado no seletor
const onUserChange = (event) => {
    if (event.value) {
        userStore.setUser(event.value);
        // Recarrega a página para que as novas permissões sejam aplicadas em todo o sistema
